	...
	<div id="use_all" style="margin: 124px auto 124px auto;">
		...
		<div id="use_text_all">
			<div class="text">
				...
				<h3>다양한 <strong>spoid</strong> 서비스를 즐겨보세요.</h3>
				<ul>
				...
				<h3>회원으로 가입하시면 <strong>spoid</strong> 서비스를 보다 편리하게 이용할 수 있습니다.</h3>
				<ul>
					<li class="text_li text_first">회원은 자신의 계정을 통해 좀더 다양한 <strong>spoid</strong> 서비스를 보다 편리하게 이용할 수 있습니다. <br>
													이와 관련한 상세한 내용은 계정 운영정책 및 고객센터 내 <strong>spoid</strong> 회원가입 방법 등에서 확인해 주세요.</li>    
				</ul>
				<hr class="text_hr">
				...
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 여러분의 생각과 감정이 표현된 콘텐츠를 소중히 보호할 것을 약속 드립니다. <br>
				...
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 여러분이 서비스를 이용하기 위해 일정 기간 동안 로그인 혹은 접속한 기록이 없는 경우, 전자메일, <br>
				...
				<h3><strong>spoid</strong>에서 제공하는 다양한 포인트를 요긴하게 활용해 보세요.</h3>
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 여러분이 <strong>spoid</strong> 서비스를 효율적으로 이용할 수 있도록 포인트를 부여하고 있습니다. <br>
													포인트는 여러분의 일정한 <strong>spoid</strong> 서비스 이용과 연동하여 <strong>spoid</strong>가 임의로 책정하거나 조정하여 지급하는 일정한 계산 단위를 갖는 <br>
													서비스 상의 가상 데이터를 말합니다. 포인트는 재산적 가치가 없기 때문에 금전으로 환불 또는 전환할 수 없지만, 포인트의 많고 <br>
													적음에 따라 여러분의 <strong>spoid</strong> 서비스 이용에 영향을 주는 경우가 있으므로 경우에 따라 적절히 활용해 보세요.</li>    
				</ul>
				<hr class="text_hr">
				
				
				<h3><strong>spoid</strong> 서비스 이용과 관련하여 몇 가지 주의사항이 있습니다.</h3>
				<ul>
				...
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 다양한 정보와 의견이 담긴 여러분의 콘텐츠를 소중히 다룰 것을 약속 드립니다만, <br>
													여러분이 게재한 게시물이 관련 법령, 본 약관, 게시물 운영정책, 각 개별 서비스에서의 약관, <br>
													운영정책 등에 위배되는 경우, 부득이 이를 비공개 또는 삭제 처리하거나 게재를 거부할 수 있습니다. <br>
													다만, 이것이 <strong>spoid</strong>가 모든 콘텐츠를 검토할 의무가 있다는 것을 의미하지는 않습니다.</li>    
				</ul>
				<hr class="text_hr">
				
				
				
				<h3><strong>spoid</strong>의 잘못은 <strong>spoid</strong>가 책임집니다.</h3>
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 여러분이 <strong>spoid</strong> 서비스를 이용함에 있어 <strong>spoid</strong>의 고의 또는 과실로 인하여 <br>
													손해를 입게 될 경우 관련 법령에 따라 여러분의 손해를 배상합니다. 다만, 천재지변 <br>
													또는 이에 준하는 불가항력으로 인하여 <strong>spoid</strong>가 서비스를 제공할 수 없거나 이용자의 고의 <br>
													또는 과실로 인하여 서비스를 이용할 수 없어 발생한 손해에 대해서 <strong>spoid</strong>는 책임을 부담하지 않습니다.</li>    
				</ul>
				<hr class="text_hr">
				
				
				
				<h3>언제든지 <strong>spoid</strong> 서비스 이용계약을 해지하실 수 있습니다.</h3>
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>에게는 참 안타까운 일입니다만, 회원은 언제든지 <strong>spoid</strong> 서비스 이용계약 해지를 신청하여 <br>
													회원에서 탈퇴할 수 있으며, 이 경우 <strong>spoid</strong>는 관련 법령 등이 정하는 바에 따라 이를 지체 없이 처리하겠습니다.</li>    
				</ul>
				<hr class="text_hr">
				
				
				
				<h3>일부 <strong>spoid</strong> 서비스에는 광고가 포함되어 있습니다.</h3>
				<ul>
					<li class="text_li text_first">여러분이 다양한 <strong>spoid</strong> 서비스를 이용하다 보면 간혹 일부 개별 서비스에 광고가<br>
													포함된 경우가 있습니다. <strong>spoid</strong> 서비스를 이용하면서 발생할 수 있는 데이터 통신요금은 가입하신 <br>
				...
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 연중 무휴, 1일 24시간 안정적으로 서비스를 제공하기 위해 최선을 다하고 있습니다만,<br>
				...
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 여러분의 소중한 의견에 귀 기울이겠습니다. 여러분은 언제든지 고객센터를 <br>
													통해 서비스 이용과 관련된 의견이나 개선사항을 전달할 수 있으며, <strong>spoid</strong>는 합리적 범위 내에서<br>
				...
				<ul>
					<li class="text_li text_first"><strong>spoid</strong>는 본 약관의 내용을 여러분이 쉽게 확인할 수 있도록 서비스 초기 화면에 게시하고 있습니다.</li>
					<li class="text_li" style="margin-bottom: 90px;"><strong>spoid</strong> 서비스에는 기본적으로 본 약관이 적용됩니다만, 부득이 각 개별 서비스의 고유한 특성을 반영하기<br>
