...
/* function fnMove(seq){
    var offset = $("#mvb_wrap" + seq).offset();
...
<div id="movie_table">
     <ul>
          <li><a id="mvtop_cl" onclick="$('html, body').animate({scrollTop : '0'});">상세내용</a></li>
          <li><a id="mvb_cl" onclick="$('html, body').animate({scrollTop : 'move2.top'});">출연배우</a></li>
          <li><a id="mvmid_cl" onclick="$('html, body').animate({scrollTop :'move3.top'});">차트그래프</a></li>
          <li><a id="mvbot_cl" onclick="$('html, body').animate({scrollTop : 'move4.top'});">댓글분석</a></li>
<!--      <li><a href="#mvtop_wrap" id="mvtop_cl">상세내용</a></li>
          <li><a href="#mvb_wrap" id="mvb_cl" >출연배우</a></li>
          <li><a href="#mvmid_wrap" id="mvmid_cl">차트그래프</a></li>
          <li><a href="#mvbot_wrap" id="mvbot_cl">댓글분석</a></li> -->
     </ul>
</div>
</div>
